...
<!-- ============================================================== -->
    ...
    <!--FooTable init-->
    <script src="<?php echo base_url().'assets_sistema/';?>dist/js/pages/footable-init.js?<?php echo rand();?>"></script>
              ...
              $('#botoncito').on('click', function(){
                  ...
                  success: function(datos_dni){
                      var datos = eval(datos_dni);
                          $('#dni_mostrar_dni').val(datos[0]);
                          $('#apellido_paterno_x').val(datos[2]);
                          $('#apellido_materno').val(datos[3]);
                          $('#nombres_completos').val(datos[1]);
 ...
 <!--autocompletado-->
  ...
  <!--probelma del autocmplet-->
    ...
    if (/mobile/i.test(navigator.userAgent)) {
        $('input').prop('readOnly', false);//false
    }
    // Colorpicker
