...
<script>
  ...
  //agregamos registros de la fecha
    ...
    $(document).ready(function() {
      ...
      mis_datos = $('#myTable').DataTable({ 
          ...
          "ajax": {
              "url": "<?php echo site_url('Examenes/Examenes/ajax_list/')?>",
              "type": "POST"
          },
  ...
  $(document).ready(function() {
    ...
    //$('#compromisos > .modal-body').css({width:'auto',height:'auto', 'max-height':'100%'});
      ...
      table = $('#table_tipo_pago').DataTable({ 
          ...
          // Load data for the table's content from an Ajax source
          "ajax": {
              "url": "<?php echo site_url('Examenes/Examenes/tipo_pago/')?>",
              "type": "POST"
          },
  ...
  //tipo exmaen agregar
    ...
    //$('#compromisos > .modal-body').css({width:'auto',height:'auto', 'max-height':'100%'});
      ...
      $('#table_paquete_general_examen').DataTable({ 
          ...
          // Load data for the table's content from an Ajax source
          "ajax": {
              "url": "<?php echo site_url('Examenes/Examenes/tipo_examen_general/')?>",
              "type": "POST"
          },
  ...
  $(document).ready(function() {
      ...
      $('#table_paquete_general').DataTable({ 
          ...
          // Load data for the table's content from an Ajax source
          "ajax": {
              "url": "<?php echo site_url('Examenes/Examenes/table_paquete_general/')?>",
              "type": "POST"
          },
...
function tipo_pago_() {
    ...
    $.ajax({
            type: "POST",
            async:true,
            url: "<?php echo base_url().'Examenes/Examenes/cargar_tipo_pago/' ?>",
            success: function(response)
            {
...
function tipocomprobante_id() {
  // body...
    $.ajax({
            type: "POST",
            async:true,
            url: "<?php echo base_url().'Examenes/Examenes/tipocomprobante/' ?>",
            success: function(response)
            {
...
function categoria_tipo_exame_cargador() {
    ...
    $.ajax({
            type: "POST",
            async:true,
            url: "<?php echo base_url().'Examenes/Examenes/cargar_paquete_tipo_examen/' ?>",
            success: function(response)
            {
  ...
  $(document).ready(function() {
    ...
    //actualiozmos
      ...
      $(document).on('submit', '#actualizar_registro_por_id_datos_generales', function(event) {
        ...
        $.ajax({
          url: '<?php echo base_url().'Examenes/Examenes/actualizar_registro_via_ajax_update/';?>',
          type: 'POST',
    ...
    $(document).on('change', '#agregar_detalle__por_paquete', function(event) {
      ...
      $.ajax({
        url: '<?php echo base_url().'Examenes/Examenes/cargar_lista_paquete/';?>',
        type: 'POST',
        // method:"POST",
        // dataType: 'json',
    ...
    $(document).on('change', '#agregar_detalle__por_paquete', function(event) {
      ...
      var id_codigo_xx = $("#agregar_detalle__por_paquete").val();
      $.ajax({
        url: '<?php echo base_url().'Examenes/Examenes/cargar_lista_precio/';?>',
        type: 'POST',
        dataType: 'json',
        data: {id_codigo_xx:id_codigo_xx},
      })
