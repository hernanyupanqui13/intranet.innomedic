<!-- ============================================================== -->
                ...
                <div class="right-sidebar">
                    <div class="slimscrollright">
                        <div class="rpanel-title"> Personalizar panel de Sistema <span><i class="ti-close right-side-toggle"></i></span> </div>
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            &copy; <?php date('Y');?>Todo los derechos reservados - <strong>Sistema de: </strong> Clinica Innomedic International <a href=""></a>
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    ...
    <!--
        Comentado por error-->
        <script src="<?php echo base_url().'assets_sistema/';?>node_modules/morrisjs/morris.min.js"></script>
    <script src="<?php echo base_url().'assets_sistema/';?>node_modules/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!-- Popup message jquery -->
    <script src="<?php echo base_url().'assets_sistema/';?>node_modules/toast-master/js/jquery.toast.js"></script>
    <!-- jQuery peity -->
    <script src="<?php echo base_url().'assets_sistema/';?>node_modules/peity/jquery.peity.min.js"></script>
    <script src="<?php echo base_url().'assets_sistema/';?>node_modules/peity/jquery.peity.init.js"></script>
    <!--Esto Igual-->
        <script src="<?php echo base_url().'assets_sistema/';?>dist/js/dashboard1.js"></script>
   ...
   <!-- This is data table -->
    ...
    <script src="<?php echo base_url().'assets_sistema/';?>node_modules/datatables/datatables.min.js"></script>
   ...
   <!--==========importar excel============-->
    ...
    <script src="<?php echo base_url().'assets_sistema/';?>node_modules/dropify/dist/js/dropify.min.js?v=<?php echo rand();?>"></script>
    ...
    <!--cargar archivos de departamento pais provincia-->
    ...
    <!--Custom JavaScript -->
    <script src="<?php echo base_url().'assets_sistema/';?>dist/js/pages/jasny-bootstrap.js"></script>
...
<!-- Footable -->
    ...
    <script src="<?php echo base_url().'assets_sistema/';?>node_modules/footable/js/footable.min.js"></script>
    <!--FooTable init-->
