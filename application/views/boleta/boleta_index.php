                            ...
                            <div class="card-body border border-info">
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <!--<div class="col-md-2">
                                                <div class="form-group">
                                                       <label class="control-label"><b>Tipo de servidor:</b></label>
                                                       <br>
                                                       <?php foreach($id_perfil as $x){ ?>
                                                           <?php
                                                               if($id_perfil_x==$x->Id){
                                                                   echo $x->perfil;
                                                               }else{
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group">
                                                        ...
                                                        <!--<input type="text" class="form-control" name="numboleta" value="<?php echo $num; ?>" id="exampleInputuname3" placeholder="Boleta Nº 00045">-->
                                                ...
                                                <label for="exampleInputuname3" class="col-sm-2 control-label">Mes</label>
                                                    <div class="col-sm-10">
                                                         <div class="input-group">
                                                            ...
                                                            <!--<?php echo "valido  del mes ".$activo; ?> <?php echo $this->uri->segment(9,0)?>-->
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($lista_escudero_by_boleta as $xx) {?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if ($xx->view==1) {?>
                                                        <span class="label label-table label-success">Nuevo <?php echo $xx->fecha_enviado; ?></span>
                                                    <?php }else{?>
                                                        <span class="label label-table label-danger">Visto == <?php echo $xx->fecha_recibido; ?></span>
                                                    <?php } ?></td>
                                                    ...
                                                    if($sub == "jpg" || $sub == "png" || $sub == "jpge" || $sub == "gif" ){ ?>
                                                        ...
                                                        <a class="data_xx_ btn btn-outline-secondary" id="<?php echo $xx->Id; ?>" href="javascript:void(0)" onclick="return mostrarmodal('<?php if($xx->archivo=="" || $xx->archivo==null){
                    ...
                    <script>
                        ...
                        if (demo=="" || demo ==null) {
                            ...
                            $("#total").html(`<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                ...
                                </div>`);//<strong>Total: </strong> <strong>`+demo+`</strong> Pedidos a la fecha <strong><?php echo date('d-m-Y');?></strong>
                    ...
                    <a   tabindex="0"
                       ...
                       data-toggle="popover" 
                       data-placement="top"
                       title="<b>!Chat online</b> - Activo" 
                      
                       style="clear: right; float: right; margin-bottom: 1em; margin-right: 1em;" >
                       <img class="v  img-responsive"  border="0"  src="<?php echo base_url().'upload/';?>oso/osito.png?v=<?php echo rand(); ?>" /></a>
                    </div>
                    </div>-->

                    <!--data-content='<img src="<?php echo base_url().'upload/';?>oso/osito1.png?v=<?php echo rand(); ?>" alt=""> <br> <a class="text-center" href="<?php echo base_url().'Chat/Online/';?>">Click Aqui!</a>' style="clear: right; float: right; margin-bottom: 1em; margin-right: 1em;" >-->
